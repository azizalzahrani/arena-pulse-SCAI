    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="p-0">
        <div className="relative">
          <div className="relative h-[500px] overflow-hidden">
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                {/* North Entry */}
                <div className="absolute left-[50%] top-[5%] -translate-x-1/2 transform">
                ...
                {/* South Entry */}
                <div className="absolute bottom-[5%] left-[50%] -translate-x-1/2 transform">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-xs font-bold text-white">
                    E2
                  </div>
                </div>
                ...
                {/* East Entry */}
                <div className="absolute right-[5%] top-[50%] -translate-y-1/2 transform">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-xs font-bold text-white">
                    E3
                  </div>
                </div>
                ...
                {/* West Exit */}
                <div className="absolute left-[5%] top-[50%] -translate-y-1/2 transform">
          ...
          <div className="absolute right-4 top-4 rounded-md bg-black/70 p-2">
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-white">Available (&lt;50%)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-yellow-500/70"></div>
                <span className="text-xs text-white">Filling Up (50-80%)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-red-500/70"></div>
                <span className="text-xs text-white">Near Capacity (&gt;80%)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-gray-500/70"></div>
          ...
          {/* AI Status */}
          <div className="absolute right-4 top-36 rounded-md bg-black/70 p-2">
            <div className="flex items-center gap-2">
